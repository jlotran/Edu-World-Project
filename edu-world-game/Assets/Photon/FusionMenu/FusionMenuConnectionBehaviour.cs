	...
	public class FusionMenuConnection : IPhotonMenuConnection
	{
		...
		public virtual async Task<ConnectResult> ConnectAsync(IPhotonMenuConnectArgs connectionArgs)
		{
			...
			var startGameArgs = new StartGameArgs()
			{
				...
				PlayerCount = connectionArgs.Scene.MaxPlayer,
			...
			{
				Debug.LogError("Fail to start game" + result.DebugMessage);
			}
		...
		public virtual Task<List<LobbyV3>> GetListLobby(IPhotonMenuConnectArgs connectArgs, GameRoomType roomType, LevelType level)
		{
