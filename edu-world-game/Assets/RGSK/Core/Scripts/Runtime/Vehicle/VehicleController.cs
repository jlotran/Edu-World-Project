...
namespace RGSK
{
    public class VehicleController : RGSKEntityComponent, IVehicle
    {
        ...
        public VehicleQuestionCatcher questionCatcher;
        ...
        public void Initialize()
        {
            ...
            _components.Add(effect);
            _components.Add(questionCatcher);
        ...
        void Start()
        {
            ...
            _isFusionRacing = RaceManager.Instance?.Session?.isFusionRacing ?? false;
        }
        ...
        public void ApplyBooters()
        {
            float _wheelTorque = engine.getBooters();
            dynamics?.ApplyMotorTorque(_wheelTorque);
        }
