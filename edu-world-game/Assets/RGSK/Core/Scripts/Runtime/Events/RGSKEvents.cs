...
namespace RGSK
{
    public static class RGSKEvents
    {
        ...
        // Question Event =====================================================
        public static readonly GameEvent OnHitQuestion = new GameEvent();
        public static readonly GameEvent<bool> OnAnswerResponse = new GameEvent<bool>();
        public static readonly GameEvent<bool> OnAnswerReady = new GameEvent<bool>();
        //Championship
        public static readonly GameEvent OnChampionshipPositionsChanged = new GameEvent();
        public static readonly GameEvent OnChampionshipFinished = new GameEvent();
        ...
        #region  Dang Update
        public static readonly GameEvent<bool> OnTimelineToggle = new GameEvent<bool>();
        public static readonly GameEvent OnTimelineRewardEnable = new GameEvent();
        public static readonly GameEvent OnTimelineRewardDisable = new GameEvent();
        #endregion
        ...
        public static readonly GameEvent OnInputBindingsChanged = new GameEvent();
