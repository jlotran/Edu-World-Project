...
namespace RGSK
{
    public class CheckpointRoute : Route
    {
        ...
        private Checkpoint_Remove _checkpointRemove;

        public Checkpoint_Remove checkpointRemove
        {
            get
            {
                if (_checkpointRemove == null)
                {
                    _checkpointRemove = GetComponentInChildren<Checkpoint_Remove>();
                }
                return _checkpointRemove;
            }
        }
