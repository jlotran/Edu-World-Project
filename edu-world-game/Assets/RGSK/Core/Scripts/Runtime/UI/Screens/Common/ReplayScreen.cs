...
namespace RGSK
{
    public class ReplayScreen : UIScreen
    {
        ...
        public override void Open()
        {
            ...
            CameraManager.Instance?.ToggleRouteCameras(true, CameraRouteType.End);
        ...
        public override void Close()
        {
            ...
            CameraManager.Instance?.ToggleRouteCameras(RaceManager.Instance.Initialized, CameraRouteType.End);
        }
