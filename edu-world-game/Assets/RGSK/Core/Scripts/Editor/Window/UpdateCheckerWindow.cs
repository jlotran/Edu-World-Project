...
namespace RGSK.Editor
{
    ...
    public class UpdateCheckerWindow : EditorWindow
    {
        ...
        {
            var window = GetWindowWithRect<UpdateCheckerWindow>(new Rect(Screen.width / 2, Screen.height / 2, 400, 355), true);
        ...
        void OnGUI()
        {
            EditorHelper.DrawHeader(position.width, position.width, false);
                ...
                case 1:
                    {
                        if (currentVersion != null && latestVersion != null)
                        {
                            ...
                            {
                                EditorGUILayout.LabelField("An update is available!", CustomEditorStyles.menuLabelCenter);
                                EditorGUILayout.LabelField("Please remember to always back up your project before updating.", CustomEditorStyles.menuLabelCenter);
                            ...
                            {
                                EditorGUILayout.LabelField("You have the latest version!", CustomEditorStyles.menuLabelCenter);
                            }
                            ...
                            GUILayout.BeginArea(new Rect(0, position.height - 40, 200, 50));
                            {
                                using (new GUILayout.VerticalScope())
                                {
                                    EditorGUILayout.LabelField($"Current version: {currentVersion.ToString()}", CustomEditorStyles.menuLabelLeft);
                                    EditorGUILayout.LabelField($"Latest version: {latestVersion.ToString()}", CustomEditorStyles.menuLabelLeft);
                                }
