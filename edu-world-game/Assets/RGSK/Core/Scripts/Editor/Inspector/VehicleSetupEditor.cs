    ...
    public class VehicleSetupEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                if (addCameraTargets)
                {
                    EditorGUILayout.HelpBox("'Chase' and 'Chase Far' targets are added by default. Assign other perspectives below to add them too.\n\nTo add default perspectives for all vehice setups, select 'Assets/RGSK/Core/Editor/Resources/RGSKEditorSettings' and add them to the 'Default Camera Perspectives' list.", MessageType.Info);
                ...
                switch (tabs[tabIndex].ToLower(System.Globalization.CultureInfo.InvariantCulture))
                {
                    ...
                    case "scvp":
                        {
                            hasIntegrationSupport = EditorHelper.SCVPSupport();
                            break;
                        }
                }
            }
        ...
        void SetupRCC()
        {
            ...
            _target.gameObject.SetChildLayers(LayerMask.NameToLayer("RCC_Vehicle"));
#endif
        }
        ...
        void SetupASHVP()
        {
            ...
            DestroyImmediate(_target.gameObject.GetComponent<AshVP.InputManager_AshVP>());
            AddCommonComponents(_target.gameObject);
        ...
        void SetupSCVP()
        {
            ...
            DestroyImmediate(_target.gameObject.GetComponent<Ashsvp.InputManager_SVP>());
            DestroyImmediate(_target.gameObject.GetComponent<Ashsvp.ResetVehicle>());

            AddCommonComponents(_target.gameObject);
            _target.gameObject.GetOrAddComponent<SCVPSupport>();
#endif
        }
