    ...
    public class TrackEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            using (new GUILayout.VerticalScope(EditorStyles.helpBox))
            {
                ...
                if (GUILayout.Button("Obstacle Route", GUILayout.Height(_btnSize)))
                {
                    CreateObstacleRoute();
                }
        ...
        void AutoUpdateProperties()
        {
            if (_target != null && _target.definition != null)
            {
                ...
                EditorUtility.SetDirty(_target.definition);
            }
        }
        ...
        void CreateObstacleRoute()
        {
            Undo.RegisterCreatedObjectUndo(
                EditorHelper.CreatePrefab(RGSKEditorSettings.Instance.obstacleRoute, _target.transform),
                "created_obstacleRoute");
        }
