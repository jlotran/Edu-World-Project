...
namespace SimpleFPS
{
	...
	public static class PlayerManager
	{
		...
		private static List<Lam.FUSION.Player>    _tempSpawnedPlayers = new List<Lam.FUSION.Player>();

		public static void UpdatePlayerConnections(NetworkRunner runner, Action<PlayerRef> spawnPlayer, Action<PlayerRef, Lam.FUSION.Player> despawnPlayer)
		{
			...
			{
				Lam.FUSION.Player    player    = _tempSpawnedPlayers[i];
